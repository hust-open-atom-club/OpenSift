...
import { getAdminGitfiles, postAdminGitfilesManual } from "@/services/csapi/api0";
...
export default function GitFileTable() {
  ...
  const { data, error, loading, run } = useRequest<API.PageDTOModelGitFileDTO, {
    pageSize?: number;
    current?: number;
  }[]>(async (arg) => {
